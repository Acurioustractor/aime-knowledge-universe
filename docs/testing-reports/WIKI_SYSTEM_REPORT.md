...
- ❌ Page exists: /wiki/*
- ✅ Component exists: WikiContentRenderer
- ✅ Component exists: WikiSearch
- ✅ Component exists: WikiSidebar
- ✅ Component exists: WikiBreadcrumbs
...
### 1. Page exists: /wiki/* failed
- **Severity**: HIGH
- **Category**: Page Availability
- **Impact**: Core functionality may be broken
- **Suggested Fix**: Implement or fix Page exists: /wiki/*
