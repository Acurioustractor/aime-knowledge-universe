            ...
            <div className="border-b border-gray-200 bg-gray-50">
                <div className="max-w-4xl mx-auto px-6 py-12">
                    ...
                    <p className="text-xl text-gray-600">
                        Twenty years of Indigenous custodianship, mentoring methodology, and systems thinking
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                        ...
                        Indigenous custodianship to systems transformation. Our approach combines traditional knowledge systems
                    ...
                    <div className="space-y-6 mb-12">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                ...
                                embed Indigenous custodianship into their operations and culture.
                            </p>
                        </div>
