            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <h1 className="text-xl font-semibold text-gray-900">AIME Knowledge Universe Wiki</h1>
                  <a 
                    href="/"
                ...
                <p className="text-sm text-gray-500">Your gateway to the moneyless economy</p>
              </div>
            </div>
          </div>
