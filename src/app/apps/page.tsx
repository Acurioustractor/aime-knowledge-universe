...
const apps: AppInfo[] = [
  {
    ...
    description: 'Interactive learning platform with Indigenous custodianship and systems thinking',
    longDescription: 'IMAGI-NATION TV is an immersive learning experience that combines storytelling, Indigenous custodianship, and systems thinking. Each episode features interactive segments, discussion prompts, and connections to AIME\'s knowledge economy where your engagement earns points.',
    icon: '📺',
    status: 'live',
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto mb-8">
              Interactive applications where engagement earns points in our knowledge economy. 
              Bridge Indigenous custodianship with modern technology while earning your way to hoodies and real-world rewards.
            </p>
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-gray-50 to-purple-50 rounded-xl border border-purple-100">
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-6">
              Each AIME app is designed with Indigenous custodianship at its core, combining traditional knowledge 
