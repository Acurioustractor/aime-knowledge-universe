...
const mockEpisodes: Episode[] = [
  {
    ...
    description: 'The first episode of IMAGI-NATION TV, introducing viewers to a new way of thinking about education and systems change through Indigenous wisdom and imagination.',
    episodeNumber: 1,
    season: 1,
    duration: 'PT25M18S',
    ...
    segments: [
      ...
      },
      {
        ...
        description: 'Indigenous wisdom about thinking seven generations ahead in decision-making'
      },
      {
        type: 'activity',
        startTime: 720,
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 max-w-3xl">
                Interactive learning experiences that bridge Indigenous wisdom with modern challenges, 
                fostering imagination and systems thinking for positive change.
              </p>
            </div>
            <div className="text-right">
              <div className="text-3xl font-light">{episodes.length}</div>
