...
const learningPathways: LearningPathway[] = [
  {
    ...
    description: 'Understand how Indigenous custodianship informs modern approaches to complex challenges through seven-generation thinking, reciprocity, and relational decision-making.',
    duration: '6-8 weeks',
      ...
      <div className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl">
            ...
            integrate Indigenous custodianship with practical application and community validation.
          </p>
        </div>
      </div>
