      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <div className="mb-8">
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            AIME's work is grounded in Indigenous wisdom that has guided communities for thousands of years. 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-orange-50 rounded-lg p-6 border border-orange-200">
            ...
            <p className="text-orange-800 mb-4">
              Indigenous wisdom places community at the center of all decision-making. This means consulting 
          ...
          <div className="space-y-4">
            ...
            <blockquote className="border-l-4 border-purple-400 pl-4 py-2 bg-purple-50 rounded-r">
              <p className="text-purple-800 italic mb-2">
                "Indigenous wisdom teaches us that we are all connected - to each other, to the land, 
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <div className="mb-8">
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            Indigenous wisdom-informed mentoring. This systematic approach unlocks imagination, builds 
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
              ...
              <p className="text-purple-800 mb-4">
                The organizational transformation methodology that embeds Indigenous wisdom into institutions. 
              ...
              <div className="bg-white p-4 rounded-lg border border-purple-300 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-purple-800">Leadership immersion in Indigenous wisdom</span>
                  </div>
                  <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start space-x-2">
                  ...
                  <span>Leadership development through Indigenous wisdom principles</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-purple-500 mt-1">•</span>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <div className="mb-8">
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            AIME's 20-year journey demonstrates the power of Indigenous wisdom applied to contemporary challenges. 
              ...
              <div className="relative flex items-start">
                ...
                <div className="ml-6 bg-purple-50 rounded-lg p-6 border border-purple-200 flex-1">
                  ...
                  <p className="text-purple-800 mb-3">
                    AIME formalizes its Indigenous wisdom-informed methodology, creating frameworks 
              ...
              <div className="relative flex items-start">
                ...
                <div className="ml-6 bg-yellow-50 rounded-lg p-6 border border-yellow-200 flex-1">
                  ...
                  <p className="text-yellow-800 mb-3">
                    ...
                    with organizations worldwide and sharing Indigenous wisdom globally.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white p-3 rounded border border-yellow-300">
                ...
                <div className="ml-6 bg-rose-50 rounded-lg p-6 border border-rose-200 flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white p-3 rounded border border-rose-300">
                      ...
                      <p className="text-xs text-rose-600">Global systems transformation through Indigenous wisdom</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex items-start">
                ...
                <div className="ml-6 bg-emerald-50 rounded-lg p-6 border border-emerald-200 flex-1">
                  ...
                  <p className="text-emerald-800 mb-3">
                    AIME creates a comprehensive knowledge universe, making 20 years of Indigenous wisdom 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white p-3 rounded border border-emerald-300">
                      ...
                      <p className="text-xs text-emerald-600">Global access to Indigenous wisdom frameworks</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
              ...
              <p className="text-blue-800 text-sm mb-3">
                Despite massive growth and change, AIME's commitment to Indigenous wisdom, 
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          A unified explanation of AIME's entire system - synthesizing 20 years of Indigenous wisdom, 
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg text-gray-600 mt-2">
                Analyze documents through AIME's Indigenous wisdom framework
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Upload a document or paste text to analyze it through AIME's Indigenous wisdom framework
                </p>
              </div>
