...
export default function Home() {
  ...
  const getRandomInsight = () => {
    const insights = [
      "Indigenous custodianship and modern systems thinking converge in unexpected ways",
      ...
      "In our knowledge economy, learning earns points and points earn hoodies"
    ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Universal access to custodianship, mentoring and imagination
              </p>
            </div>
            <div className="text-right text-sm text-gray-500">
              {stats && stats.total && (
                <p>{stats.total.toLocaleString()} knowledge assets in our moneyless economy</p>
              )}
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
            Twenty years of Indigenous custodianship, mentoring methodology, and systems 
            thinking transformed into a knowledge economy where your learning has real value.
            Join the universe where engagement earns you hoodies and imagination becomes currency.
          </p>
      ...
      {/* Featured: Ben's Goodbye Overview */}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-white bg-opacity-10 rounded-lg p-8 backdrop-blur-sm">
            <h3 className="text-2xl font-medium text-white mb-4">
              🎉 Ben's Farewell & System Handover
            </h3>
            <p className="text-blue-100 mb-6 leading-relaxed">
              Explore Ben's comprehensive overview of 20 years of AIME knowledge architecture, 
              from Indigenous knowledge systems to the unified data lake powering this platform.
            </p>
            <Link 
              href="/bens-goodbye-overview"
              className="inline-flex items-center bg-white text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors font-medium"
            >
              Watch the Handover Video →
            </Link>
          </div>
        </div>
      </section>
            ...
            <Link href="/discover" className="group">
              <div className="bg-white p-8 h-full hover:bg-gray-50 transition-colors border-l-4 border-transparent hover:border-gray-300">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Browse through our comprehensive collection of transformational tools, 
                  business cases, and video content. Perfect for exploration 
            ...
            <Link href="/apps" className="group">
              <div className="bg-white p-8 h-full hover:bg-gray-50 transition-colors border-l-4 border-transparent hover:border-purple-300">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  ...
                  From the transformative Hoodie Journey to real-time Impact Dashboards, experience 
                  imagination-powered learning.
                </p>
                <div className="text-sm text-gray-500">
                  <span>🎓 Hoodie Journey</span>
                  <span className="mx-2">•</span>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <Link 
                  ...
                  className="block text-gray-700 hover:text-gray-900 py-2 border-b border-gray-100 hover:border-gray-300 transition-colors"
                >
                  How does Indigenous custodianship inform systems change?
                </Link>
                <Link 
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                >
                  <span className="text-gray-700">🎓 Hoodie Journey</span>
                  <span className="text-sm text-gray-500">
                    Transformative experience
                  </span>
                </Link>
                <Link 
                  href="/impact-dashboards"
                  className="flex justify-between items-center py-3 hover:bg-gray-50 px-4 -mx-4 transition-colors"
                >
                  <span className="text-gray-700">📊 Impact Dashboard</span>
                  <span className="text-sm text-gray-500">
                    Real-time AIME impact
                  </span>
                </Link>
                <Link 
                  href="/apps"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <VideoFeed 
            ...
            subtitle="Interactive learning experiences bridging Indigenous custodianship with modern challenges"
            limit={3}
            variant="grid"
            filter="featured"
            showHeader={true}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="flex justify-center space-x-8 text-sm">
              ...
              <Link href="/hoodie-journey" className="text-gray-400 hover:text-white transition-colors">
                🎓 Hoodie Journey
              </Link>
