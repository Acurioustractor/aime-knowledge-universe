...
export default function BusinessCasesPage() {
  ...
  const loadAllCases = async () => {
    ...
    try {
      ...
      const fallbackCases = [
        {
          id: 'joy-corps',
          title: 'Joy Corps: Organizational Transformation Through Indigenous Custodianship',
          description: 'This document explores how organizations can embed Indigenous custodianship into their operations through the Joy Corps methodology. It demonstrates systematic transformation approaches that prioritize relationships, community benefit, and seven-generation thinking in corporate environments.',
        ...
        },
        {
          ...
          description: 'This document details the IMAGI-Labs approach to creating innovation hubs that blend Indigenous custodianship with cutting-edge creative methodologies. It shows how imagination becomes a practical tool for transformation.',
  ...
  const processBusinessCaseClientSide = async (content: string, title: string) => {
    ...
    // Categorization for Joy Corp pathways
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Joy Corp pathways...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Joy Corp Pathways Not Available</h2>
          <p className="text-gray-600">Please check the Joy Corp pathways data source.</p>
        </div>
      </div>
    )
  }
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Joy Corp Pathways</h1>
          ...
          <div className="mt-6 bg-blue-50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-blue-900 mb-3">Quick Access to All Joy Corp Pathways</h3>
        ...
        {activeTab === 'upload' ? (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                <div className="p-6 border-b border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Most common themes across Joy Corp transformations</p>
                </div>
            ...
            <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-900">Core Joy Corp Pathways</h2>
