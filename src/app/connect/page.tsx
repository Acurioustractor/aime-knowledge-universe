...
const mentoringOpportunities: MentoringOpportunity[] = [
  ...
  },
  {
    ...
    description: 'Elder knowledge keeper offering guidance on appropriate protocols for sharing Indigenous custodianship in educational contexts.',
      ...
      <div className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl">
            ...
            on implementing Indigenous custodianship and systems thinking in your context.
          </p>
        </div>
      </div>
        ...
        {activeTab === 'collaborate' && (
          <div>
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Join collaborative projects that apply Indigenous custodianship and systems thinking 
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: 'Designing and implementing youth leadership programs that center Indigenous custodianship and systems thinking.',
                  participants: 6,
            ...
            <div className="mt-12 bg-gray-900 text-white p-12 rounded-lg text-center">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Have an idea for applying Indigenous custodianship to systemic challenges? 
