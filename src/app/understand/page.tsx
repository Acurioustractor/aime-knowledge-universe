          ...
          <div className="lg:col-span-2">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-8">
                Click on any concept to explore its connections and see how Indigenous custodianship 
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-gray-50 p-6">
              ...
              <div className="space-y-3">
                {[
                  { type: 'principle', label: 'Core Principles', desc: 'Fundamental Indigenous custodianship' },
