        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Discover unexpected connections across AIME's 20+ years of Indigenous custodianship, 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Unexpected connections that reveal the interconnected nature of Indigenous custodianship and modern applications.
            </p>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  ...
                  This exploration tool serves to honor and amplify Indigenous custodianship, not appropriate it.
                </p>
              </div>
            </div>
          </div>
