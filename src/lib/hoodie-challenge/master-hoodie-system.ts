...
export const MASTER_HOODIE_CATEGORIES = {
  INDIGENOUS_WISDOM: {
    name: 'Indigenous Custodianship',
    description: 'Hoodies earned through deep engagement with Indigenous custodianship systems',
    color: '#8B4513',
    maxHoodies: 25
  },
  NATURE_CONNECTION: {
...
export class HoodieEconomicsEngine {
  ...
  static calculateScore(profile: MasterHoodieProfile): number {
    ...
    // Indigenous Custodianship Bonus (deep engagement with cultural content)
