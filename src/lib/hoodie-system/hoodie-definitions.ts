 ...
 * Each lesson completion earns a unique digital hoodie representing Indigenous custodianship and AIME values
 */
...
export const MENTOR_APP_HOODIES: DigitalHoodie[] = [
  ...
  // The ultimate reward - physical hoodie
  {
    ...
    description: 'The ultimate hoodie - a physical AIME hoodie shipped to your door. You have mastered the 18 principles of mentorship through Indigenous custodianship.',
