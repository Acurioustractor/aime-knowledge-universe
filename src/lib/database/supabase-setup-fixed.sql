-- AIME Wiki Supabase Database Schema (FIXED VERSION)
...
-- Simplified full-text search index (avoids IMMUTABLE function issues)
...
-- Auto-update timestamps function (FIXED)
