...
const seedEpisodes: SeedEpisodeData[] = [
  {
    ...
    description: 'The first episode of IMAGI-NATION TV, introducing viewers to a new way of thinking about education and systems change through Indigenous wisdom and imagination. Jack Manning Bancroft welcomes viewers to a transformational journey that bridges traditional knowledge with modern challenges.',
    ...
    learningObjectives: [
      ...
      'Explore the connection between Indigenous wisdom and systems thinking',
    ...
    segments: [
      ...
      },
      {
        ...
        description: 'Indigenous wisdom about thinking seven generations ahead in decision-making and its relevance to modern challenges',
