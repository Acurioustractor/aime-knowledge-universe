...
const conceptLinks: ConceptLink[] = [
  ...
  },
  {
    id: 'imagi-nation',
    term: 'IMAGI-NATION',
    definition: 'A global movement for systemic change that prioritizes relationships, Indigenous custodianship, and community wellbeing over profit and extraction.',
