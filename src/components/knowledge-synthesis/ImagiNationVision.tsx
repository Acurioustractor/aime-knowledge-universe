...
const visionElements: VisionElement[] = [
  ...
  },
  {
    ...
    description: "Elevation and integration of Indigenous wisdom in global decision-making and problem-solving.",
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-700 max-w-3xl">
          A global movement for systemic change that prioritizes relationships, Indigenous wisdom, 
        ...
        <div>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg p-8 mb-8">
            ...
            <p className="text-lg leading-relaxed">
              We imagine a world where every young person knows they matter, where Indigenous wisdom 
