...
export default function WikiSidebar({ 
  ...
  const wikiStructure: WikiSection[] = [
    {
      ...
      pages: [
        ...
        { id: 'philosophy', title: 'Our Philosophy', description: 'Indigenous custodianship and systems thinking' },
  ...
  return (
    <div className="fixed left-0 top-0 w-80 h-full bg-gray-50 border-r border-gray-200 overflow-y-auto z-40">
