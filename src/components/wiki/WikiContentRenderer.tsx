  ...
  const getPageContent = (section: string, page: string) => {
    ...
    if (section === 'overview' && page === 'introduction') {
      return {
        ...
        subtitle: 'Your comprehensive guide to Indigenous custodianship and systems transformation',
        content: `
          <div class="prose prose-lg max-w-none">
            <p class="text-xl text-gray-600 mb-6">
              The AIME Knowledge Universe is a comprehensive repository of Indigenous custodianship, 
            ...
            content: `
              <div class="prose prose-lg max-w-none">
                ...
                <p>
                  ...
                  Indigenous custodianship is honored in its application.
                </p>
              </div>
            `,
            quickLinks: [
            ...
            content: `
              <div class="prose prose-lg max-w-none">
                ...
                <p>
                  ...
                  economies worldwide. It connects Indigenous custodianship with contemporary 
    ...
    if (section === 'tools-frameworks') {
      switch (page) {
        case 'overview':
          return {
            title: 'Tools & Frameworks Overview',
            subtitle: 'Practical implementation resources for transformation',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                  AIME's Tools & Frameworks collection contains over 234 practical resources 
                  developed through 20 years of implementation experience. These tools bridge 
                  Indigenous custodianship with contemporary practice, enabling individuals and 
                  organizations to apply transformative approaches effectively.
                </p>

                <h2>Categories of Tools</h2>
                <div class="grid md:grid-cols-2 gap-6 my-8">
                  <div class="bg-purple-50 p-6 rounded-lg">
                    <h3 class="text-purple-800 font-semibold mb-3">🔍 Assessment Tools</h3>
                    <p class="text-sm text-gray-700">
                      Diagnostic frameworks to understand current state, identify gaps, and 
                      measure progress across individual, organizational, and systems levels.
                    </p>
                  </div>
                  <div class="bg-blue-50 p-6 rounded-lg">
                    <h3 class="text-blue-800 font-semibold mb-3">📋 Planning Frameworks</h3>
                    <p class="text-sm text-gray-700">
                      Strategic planning approaches that integrate Indigenous thinking patterns 
                      with practical implementation methodologies.
                    </p>
                  </div>
                  <div class="bg-green-50 p-6 rounded-lg">
                    <h3 class="text-green-800 font-semibold mb-3">🎯 Facilitation Guides</h3>
                    <p class="text-sm text-gray-700">
                      Step-by-step resources for running workshops, conversations, and 
                      learning experiences that honor Indigenous protocols.
                    </p>
                  </div>
                  <div class="bg-orange-50 p-6 rounded-lg">
                    <h3 class="text-orange-800 font-semibold mb-3">📊 Evaluation Methods</h3>
                    <p class="text-sm text-gray-700">
                      Holistic evaluation approaches that capture quantitative outcomes 
                      and qualitative impacts including relationship and cultural dimensions.
                    </p>
                  </div>
                </div>
                ...
                <ul>
                  <li><strong>Culturally Grounded:</strong> All tools respect Indigenous protocols and worldviews</li>
                  <li><strong>Practically Tested:</strong> Every resource has been refined through real-world application</li>
                  <li><strong>Adaptable:</strong> Frameworks can be customized for different contexts and communities</li>
                  <li><strong>Relationship-Centered:</strong> Tools prioritize connection and collective wisdom</li>
                  <li><strong>Systems-Aware:</strong> Approaches consider interconnections and long-term impacts</li>
                </ul>

                <h2>Application Contexts</h2>
                <h3>Educational Settings</h3>
                <p>
                  Curriculum design tools, student engagement frameworks, and assessment 
                  methods that recognize diverse learning styles and cultural knowledge.
                </p>

                <h3>Organizational Development</h3>
                <p>
                  Change management frameworks, leadership development tools, and culture 
                  transformation guides for institutions seeking Indigenous-informed approaches.
                </p>

                <h3>Community Programs</h3>
                <p>
                  Program design templates, community engagement protocols, and impact 
                  measurement frameworks for grassroots and community-based initiatives.
                </p>

                <h3>Policy and Systems</h3>
                <p>
                  Policy analysis frameworks, stakeholder engagement tools, and systems 
                  mapping resources for large-scale transformation efforts.
                </p>
              </div>
            `,
            quickLinks: [
              { title: 'Assessment Tools', section: 'tools-frameworks', page: 'assessment-tools' },
              { title: 'Planning Frameworks', section: 'tools-frameworks', page: 'planning-frameworks' },
              { title: 'Facilitation Guides', section: 'tools-frameworks', page: 'facilitation-guides' },
              { title: 'Digital Tools', section: 'tools-frameworks', page: 'digital-tools' }
            ]
          }
        ...
        case 'assessment-tools':
          return {
            ...
            subtitle: 'Diagnostic frameworks for understanding and measuring progress',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                  Assessment in Indigenous-informed practice goes beyond traditional metrics 
                  to include relationship quality, cultural connection, and systems thinking 
                  capabilities. These tools provide holistic frameworks for understanding 
                  current state and measuring meaningful progress.
                </p>

                <h2>Individual Assessment Tools</h2>
                
                <h3>🌟 Imagination Readiness Assessment</h3>
                <p>
                  Evaluates an individual's capacity to think imaginatively, embrace possibility, 
                  and contribute to creative problem-solving. Measures comfort with ambiguity, 
                  creative confidence, and willingness to challenge conventional thinking.
                </p>
                <div class="bg-blue-50 p-4 rounded-lg my-4">
                  <strong>Key Dimensions:</strong> Creative Confidence, Perspective-Taking, 
                  Risk Tolerance, Collaborative Spirit, Cultural Curiosity
                </div>

                <h3>🤝 Relationship Intelligence Scale</h3>
                <p>
                  Assesses ability to build, maintain, and leverage relationships for positive 
                  impact. Includes emotional intelligence, cultural sensitivity, and network 
                  awareness components.
                </p>

                <h3>🔄 Systems Thinking Capacity</h3>
                <p>
                  Measures understanding of interconnections, ability to see patterns across 
                  time and context, and capacity to think in terms of whole systems rather 
                  than isolated parts.
                </p>

                <h2>Organizational Assessment Tools</h2>

                <h3>🏢 Cultural Intelligence Audit</h3>
                <p>
                  Comprehensive assessment of organizational cultural awareness, inclusion 
                  practices, and capacity to work effectively across cultural differences. 
                  Includes policy review, practice observation, and stakeholder feedback.
                </p>

                <h3>📈 Innovation Ecosystem Mapping</h3>
                <p>
                  Evaluates organizational capacity for innovation including leadership support, 
                  resource allocation, risk tolerance, and learning culture. Maps formal and 
                  informal innovation networks.
                </p>

                <h3>🌱 Change Readiness Diagnostic</h3>
                <p>
                  Assesses organizational readiness for transformation including stakeholder 
                  engagement, resource availability, leadership commitment, and cultural factors 
                  that support or hinder change.
                </p>

                <h2>Community Assessment Tools</h2>

                <h3>🏘️ Community Asset Mapping</h3>
                <p>
                  Identifies existing strengths, resources, and capabilities within communities. 
                  Goes beyond traditional needs assessment to focus on assets, relationships, 
                  and cultural wealth.
                </p>

                <h3>🤗 Social Cohesion Index</h3>
                <p>
                  Measures trust levels, social capital, collective efficacy, and community 
                  resilience. Includes both quantitative metrics and qualitative indicators 
                  of community health.
                </p>

                <h2>Using Assessment Tools Effectively</h2>
                <ul>
                  <li><strong>Co-design Process:</strong> Involve stakeholders in adapting tools to context</li>
                  <li><strong>Multiple Perspectives:</strong> Gather input from diverse viewpoints</li>
                  <li><strong>Strengths Focus:</strong> Identify assets and capabilities, not just gaps</li>
                  <li><strong>Action Orientation:</strong> Use results to inform strategy and planning</li>
                  <li><strong>Ongoing Monitoring:</strong> Regular reassessment to track progress</li>
                </ul>
              </div>
            `
          }

        case 'planning-frameworks':
          return {
            title: 'Planning Frameworks',
            subtitle: 'Strategic approaches that integrate Indigenous custodianship with practical implementation',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                  Planning in Indigenous-informed practice is circular rather than linear, 
                  relationship-centered rather than task-focused, and considers seven generations 
                  of impact rather than short-term outcomes. These frameworks provide structure 
                  while honoring Indigenous approaches to strategy and implementation.
                </p>

                <h2>Core Planning Frameworks</h2>

                <h3>🔄 Spiral Planning Model</h3>
                <p>
                  Based on Indigenous understanding of time as circular rather than linear. 
                  Plans develop through iterative cycles that honor reflection, relationship 
                  building, and emergent learning alongside goal achievement.
                </p>
                <div class="bg-purple-50 p-6 rounded-lg my-6">
                  <h4 class="font-semibold mb-3">Four Phases of Spiral Planning:</h4>
                  <ol class="space-y-2">
                    <li><strong>🌱 Dreaming Phase:</strong> Vision creation and possibility exploration</li>
                    <li><strong>🗺️ Mapping Phase:</strong> Resource identification and pathway planning</li>
                    <li><strong>🏃 Action Phase:</strong> Implementation with continuous adaptation</li>
                    <li><strong>🤔 Reflection Phase:</strong> Learning harvest and wisdom integration</li>
                  </ol>
                </div>

                <h3>🌿 Seven Generation Planning</h3>
                <p>
                  Traditional Indigenous approach that considers the impact of decisions on 
                  seven generations into the future. Provides framework for long-term thinking 
                  and sustainable decision-making.
                </p>

                <h3>🕸️ Web of Relationships Framework</h3>
                <p>
                  Maps stakeholders, resources, and connections as an interconnected web rather 
                  than hierarchical structure. Plans account for relationship dynamics and 
                  network effects in strategy development.
                </p>

                <h2>Specialized Planning Approaches</h2>

                <h3>📚 Educational Program Design</h3>
                <div class="bg-blue-50 p-4 rounded-lg my-4">
                  <h4 class="font-semibold mb-2">AIME Curriculum Planning Framework:</h4>
                  <ul class="text-sm space-y-1">
                    <li><strong>Story:</strong> Narrative foundation that connects learning to life</li>
                    <li><strong>Imagination:</strong> Creative activities that expand possibilities</li>
                    <li><strong>Mentoring:</strong> Relationship-based learning and support</li>
                    <li><strong>Connection:</strong> Links between knowledge and real-world application</li>
                    <li><strong>Action:</strong> Opportunities to contribute and create change</li>
                  </ul>
                </div>

                <h3>🏢 Organizational Transformation Planning</h3>
                <p>
                  Framework for guiding institutions through culture change that honors both 
                  Indigenous values and operational effectiveness. Balances transformation 
                  goals with relationship preservation.
                </p>

                <h3>🌍 Community Development Planning</h3>
                <p>
                  Asset-based community development approach that builds on existing strengths 
                  and cultural resources. Emphasizes community ownership and culturally 
                  appropriate solutions.
                </p>

                <h2>Implementation Principles</h2>
                <ul>
                  <li><strong>Start with Relationships:</strong> Invest in connections before tasks</li>
                  <li><strong>Honor Indigenous Protocols:</strong> Respect cultural practices and permissions</li>
                  <li><strong>Plan for Emergence:</strong> Allow for unexpected opportunities and learning</li>
                  <li><strong>Think in Circles:</strong> Embrace iterative, cyclical approaches</li>
                  <li><strong>Consider Seven Generations:</strong> Evaluate long-term impacts</li>
                  <li><strong>Build on Assets:</strong> Start with what's working and build from strength</li>
                </ul>

                <h2>Planning Tools and Templates</h2>
                <h3>✅ Planning Checklists</h3>
                <ul>
                  <li>Stakeholder relationship mapping checklist</li>
                  <li>Cultural protocol consideration guide</li>
                  <li>Resource and asset inventory template</li>
                  <li>Risk and opportunity assessment framework</li>
                </ul>

                <h3>📊 Planning Templates</h3>
                <ul>
                  <li>Spiral planning cycle template</li>
                  <li>Seven generation impact assessment</li>
                  <li>Relationship web mapping tool</li>
                  <li>Story-based program design template</li>
                </ul>
              </div>
            `
          }

        case 'facilitation-guides':
          return {
            title: 'Facilitation Guides',
            subtitle: 'Resources for running transformative workshops and learning experiences',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                  Facilitation in Indigenous-informed practice creates sacred space for learning, 
                  honors multiple ways of knowing, and guides groups through transformative 
                  experiences. These guides provide practical frameworks for facilitating 
                  workshops, conversations, and programs that bridge worlds.
                </p>

                <h2>Foundational Facilitation Principles</h2>
                
                <div class="bg-green-50 p-6 rounded-lg my-6">
                  <h3 class="text-green-800 font-semibold mb-4">🔥 Circle Principles</h3>
                  <ul class="space-y-2 text-sm">
                    <li><strong>Sacred Space:</strong> Create environment of respect and safety</li>
                    <li><strong>Shared Leadership:</strong> Everyone has wisdom to contribute</li>
                    <li><strong>Speaking from Heart:</strong> Encourage authentic expression</li>
                    <li><strong>Listening with Intent:</strong> Deep hearing beyond words</li>
                    <li><strong>Trust the Process:</strong> Allow emergence and organic flow</li>
                  </ul>
                </div>

                <h2>Workshop Facilitation Guides</h2>

                <h3>🌟 Imagination Workshop Framework</h3>
                <p>
                  Three-hour workshop design for expanding creative thinking and possibility. 
                  Combines storytelling, creative exercises, and group visioning to unlock 
                  imaginative capacity.
                </p>
                <div class="bg-purple-50 p-4 rounded-lg my-4">
                  <h4 class="font-semibold mb-2">Workshop Flow:</h4>
                  <ol class="text-sm space-y-1">
                    <li><strong>Opening Circle (20 min):</strong> Introductions and intention setting</li>
                    <li><strong>Story Sharing (40 min):</strong> Personal stories of transformation</li>
                    <li><strong>Imagination Exercises (60 min):</strong> Creative thinking activities</li>
                    <li><strong>Visioning (45 min):</strong> Collective possibility creation</li>
                    <li><strong>Action Planning (30 min):</strong> Next steps and commitments</li>
                    <li><strong>Closing Circle (15 min):</strong> Gratitude and completion</li>
                  </ol>
                </div>

                <h3>🤝 Relationship Building Workshop</h3>
                <p>
                  Half-day workshop focused on developing authentic connections and building 
                  trust within teams or communities. Incorporates Indigenous relationship 
                  protocols and contemporary team building.
                </p>

                <h3>🔄 Systems Thinking Workshop</h3>
                <p>
                  Full-day workshop for developing systems awareness and thinking capabilities. 
                  Uses Indigenous knowledge frameworks alongside systems mapping tools.
                </p>

                <h2>Conversation Facilitation</h2>

                <h3>💬 Courageous Conversations Guide</h3>
                <p>
                  Framework for facilitating difficult conversations about race, culture, 
                  privilege, and power. Provides structure for safe, productive dialogue 
                  across difference.
                </p>

                <h3>🌈 Cultural Bridge Conversations</h3>
                <p>
                  Protocols for facilitating meaningful exchange between Indigenous and 
                  non-Indigenous perspectives. Emphasizes respect, learning, and mutual benefit.
                </p>

                <h2>Learning Experience Design</h2>

                <h3>📚 Cultural Learning Experiences</h3>
                <p>
                  Templates for designing learning experiences that honor Indigenous knowledge 
                  while meeting contemporary educational objectives. Includes both online and 
                  in-person formats.
                </p>

                <h3>🎯 Skill-Building Workshop Templates</h3>
                <ul>
                  <li>Leadership development workshop series</li>
                  <li>Mentoring skills training program</li>
                  <li>Cultural competency learning journey</li>
                  <li>Innovation and creativity workshop</li>
                </ul>

                <h2>Facilitation Techniques</h2>

                <h3>🎨 Creative Engagement Methods</h3>
                <ul>
                  <li><strong>Storytelling Circles:</strong> Sharing experiences and wisdom</li>
                  <li><strong>Art-Based Activities:</strong> Drawing, painting, crafting for expression</li>
                  <li><strong>Movement and Dance:</strong> Embodied learning and energy building</li>
                  <li><strong>Music and Song:</strong> Cultural expression and community building</li>
                  <li><strong>Nature-Based Activities:</strong> Outdoor learning and connection</li>
                </ul>

                <h3>🗣️ Discussion Facilitation Tools</h3>
                <ul>
                  <li><strong>Talking Circle:</strong> Equal voice and sacred listening</li>
                  <li><strong>World Café:</strong> Small group rotation and cross-pollination</li>
                  <li><strong>Open Space:</strong> Self-organizing and emergent topics</li>
                  <li><strong>Appreciative Inquiry:</strong> Strengths-based exploration</li>
                  <li><strong>Future Search:</strong> Collective visioning and planning</li>
                </ul>

                <h2>Cultural Protocols and Considerations</h2>
                <ul>
                  <li><strong>Land Acknowledgment:</strong> Honor Traditional Custodians</li>
                  <li><strong>Elder Inclusion:</strong> Respect for wisdom keepers</li>
                  <li><strong>Cultural Permissions:</strong> Appropriate sharing and attribution</li>
                  <li><strong>Sacred Objects:</strong> Proper handling and respect</li>
                  <li><strong>Closing Protocols:</strong> Proper completion and gratitude</li>
                </ul>
              </div>
            `
          }
        ...
        case 'evaluation-methods':
          return {
            ...
            subtitle: 'Holistic approaches to measuring impact and learning',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                  Evaluation in Indigenous-informed practice honors multiple ways of knowing, 
                  values relationship and cultural outcomes alongside quantitative measures, 
                  and serves learning and improvement rather than just accountability. These 
                  methods provide frameworks for capturing the full spectrum of impact.
                </p>

                <h2>Indigenous-Informed Evaluation Principles</h2>
                
                <div class="bg-orange-50 p-6 rounded-lg my-6">
                  <h3 class="text-orange-800 font-semibold mb-4">🌟 Core Values</h3>
                  <ul class="space-y-2 text-sm">
                    <li><strong>Relational Accountability:</strong> Responsible to relationships and community</li>
                    <li><strong>Cultural Responsiveness:</strong> Methods honor Indigenous worldviews</li>
                    <li><strong>Participatory Approach:</strong> Community involvement in design and interpretation</li>
                    <li><strong>Strengths-Based:</strong> Focus on assets and positive outcomes</li>
                    <li><strong>Learning-Oriented:</strong> Evaluation serves continuous improvement</li>
                    <li><strong>Holistic Perspective:</strong> Considers whole person and whole system</li>
                  </ul>
                </div>

                <h2>Evaluation Frameworks</h2>

                <h3>🔄 Spiral Evaluation Model</h3>
                <p>
                  Continuous, cyclical evaluation approach that mirrors Indigenous understanding 
                  of time and learning. Integrates ongoing reflection, story collection, and 
                  adaptive learning throughout program cycles.
                </p>
                <div class="bg-purple-50 p-4 rounded-lg my-4">
                  <h4 class="font-semibold mb-2">Four Phases of Spiral Evaluation:</h4>
                  <ol class="text-sm space-y-1">
                    <li><strong>🌱 Dreaming:</strong> Vision articulation and success definition</li>
                    <li><strong>🗺️ Mapping:</strong> Baseline data and pathway identification</li>
                    <li><strong>🏃 Tracking:</strong> Continuous monitoring and story collection</li>
                    <li><strong>🤔 Harvesting:</strong> Learning synthesis and wisdom integration</li>
                  </ol>
                </div>

                <h3>🌿 Most Significant Change Methodology</h3>
                <p>
                  Participatory narrative approach that collects stories of significant change 
                  from stakeholders. Particularly effective for capturing unexpected outcomes 
                  and relationship-based impacts.
                </p>

                <h3>📊 Balanced Scorecard for Indigenous Programs</h3>
                <p>
                  Adapted scorecard approach that balances quantitative metrics with cultural 
                  indicators, relationship measures, and community-defined success criteria.
                </p>

                <h2>Data Collection Methods</h2>

                <h3>📖 Story-Based Evaluation</h3>
                <p>
                  Systematic collection and analysis of participant stories to understand 
                  impact, learning, and transformation. Stories provide rich qualitative 
                  data about personal and community change.
                </p>
                <ul class="text-sm space-y-1">
                  <li>Structured story interviews</li>
                  <li>Digital storytelling projects</li>
                  <li>Story circles and sharing sessions</li>
                  <li>Visual storytelling through art and photography</li>
                </ul>

                <h3>🎯 Outcome Harvesting</h3>
                <p>
                  Retrospective approach that identifies actual outcomes achieved rather than 
                  measuring against predetermined indicators. Particularly useful for complex, 
                  adaptive programs.
                </p>

                <h3>🌐 Network Mapping and Analysis</h3>
                <p>
                  Evaluation of relationship building, network strengthening, and social capital 
                  development. Maps connections, influence patterns, and collaboration quality.
                </p>

                <h3>🎨 Creative Data Collection</h3>
                <ul>
                  <li><strong>Photovoice:</strong> Participant-led photography with reflection</li>
                  <li><strong>Arts-Based Evaluation:</strong> Expression through visual arts, music, dance</li>
                  <li><strong>Mapping Exercises:</strong> Community asset mapping and change visualization</li>
                  <li><strong>Timeline Activities:</strong> Collective memory and progress tracking</li>
                </ul>

                <h2>Measurement Domains</h2>

                <h3>🧠 Individual Transformation</h3>
                <ul>
                  <li>Imagination and creative confidence</li>
                  <li>Cultural identity and pride</li>
                  <li>Leadership capacity and voice</li>
                  <li>Academic and life skills development</li>
                  <li>Relationship building abilities</li>
                  <li>Future aspirations and goal clarity</li>
                </ul>

                <h3>🤝 Relationship and Social Outcomes</h3>
                <ul>
                  <li>Quality of mentoring relationships</li>
                  <li>Peer support and collaboration</li>
                  <li>Family and community connections</li>
                  <li>Cross-cultural understanding</li>
                  <li>Network expansion and strengthening</li>
                  <li>Social capital development</li>
                </ul>

                <h3>🏛️ Organizational and Systems Change</h3>
                <ul>
                  <li>Cultural competency development</li>
                  <li>Policy and practice changes</li>
                  <li>Staff capacity and confidence</li>
                  <li>Institutional partnership quality</li>
                  <li>Resource allocation shifts</li>
                  <li>Sustainability planning and implementation</li>
                </ul>

                <h3>🌍 Community and Cultural Impact</h3>
                <ul>
                  <li>Cultural knowledge preservation and transmission</li>
                  <li>Community pride and cohesion</li>
                  <li>Local economic development</li>
                  <li>Environmental stewardship</li>
                  <li>Intergenerational connection</li>
                  <li>Cultural celebration and expression</li>
                </ul>

                <h2>Evaluation Tools and Instruments</h2>

                <h3>📋 Survey and Assessment Tools</h3>
                <ul>
                  <li>Cultural identity scale</li>
                  <li>Relationship quality assessment</li>
                  <li>Leadership confidence inventory</li>
                  <li>Imagination and creativity measures</li>
                  <li>Community connection survey</li>
                  <li>Future aspirations mapping</li>
                </ul>

                <h3>🎤 Interview and Focus Group Guides</h3>
                <ul>
                  <li>Participant journey interview protocol</li>
                  <li>Mentor relationship exploration guide</li>
                  <li>Family impact discussion framework</li>
                  <li>Community stakeholder interview guide</li>
                  <li>Staff and volunteer feedback protocol</li>
                </ul>

                <h2>Using Evaluation for Learning</h2>
                <ul>
                  <li><strong>Regular Reflection Cycles:</strong> Built-in times for learning and adjustment</li>
                  <li><strong>Stakeholder Feedback Loops:</strong> Continuous input from participants and community</li>
                  <li><strong>Data Storytelling:</strong> Sharing evaluation findings through narrative</li>
                  <li><strong>Adaptive Management:</strong> Using evaluation to guide program evolution</li>
                  <li><strong>Capacity Building:</strong> Developing evaluation skills within community</li>
                </ul>
              </div>
            `
          }
        ...
        case 'digital-tools':
          return {
            title: 'Digital Tools',
            subtitle: 'Technology resources that support Indigenous-informed practice',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-xl text-gray-600 mb-6">
                  Digital tools in Indigenous-informed practice honor traditional ways of knowing 
                  while leveraging technology to expand reach, enhance connection, and amplify 
                  impact. These tools are designed with cultural protocols in mind and serve 
                  relationship-building and community empowerment goals.
                </p>

                <h2>Platform and Application Categories</h2>

                <div class="grid md:grid-cols-2 gap-6 my-8">
                  <div class="bg-blue-50 p-6 rounded-lg">
                    <h3 class="text-blue-800 font-semibold mb-3">💻 Learning Management Systems</h3>
                    <p class="text-sm text-gray-700">
                      Culturally responsive platforms for delivering education and training 
                      that honor Indigenous learning styles and community protocols.
                    </p>
                  </div>
                  <div class="bg-green-50 p-6 rounded-lg">
                    <h3 class="text-green-800 font-semibold mb-3">🤝 Relationship Management</h3>
                    <p class="text-sm text-gray-700">
                      Tools for tracking mentoring relationships, community connections, 
                      and network development with privacy and cultural sensitivity.
                    </p>
                  </div>
                  <div class="bg-purple-50 p-6 rounded-lg">
                    <h3 class="text-purple-800 font-semibold mb-3">📊 Impact Measurement</h3>
                    <p class="text-sm text-gray-700">
                      Data collection and analysis tools that capture both quantitative 
                      outcomes and qualitative stories of transformation.
                    </p>
                  </div>
                  <div class="bg-orange-50 p-6 rounded-lg">
                    <h3 class="text-orange-800 font-semibold mb-3">🎨 Creative Expression</h3>
                    <p class="text-sm text-gray-700">
                      Digital platforms for storytelling, art creation, and cultural 
                      expression that support imagination and creativity.
                    </p>
                  </div>
                </div>
                ...
                <h3>🏫 AIME Learning Hub</h3>
                <p>
                  Comprehensive learning management system designed specifically for Indigenous 
                  education contexts. Features include story-based learning modules, peer 
                  mentoring tools, and cultural protocol integration.
                </p>
                <div class="bg-blue-50 p-4 rounded-lg my-4">
                  <h4 class="font-semibold mb-2">Key Features:</h4>
                  <ul class="text-sm space-y-1">
                    <li>📖 Story-centered curriculum delivery</li>
                    <li>🤝 Mentoring relationship tracking</li>
                    <li>🎯 Personalized learning pathways</li>
                    <li>📊 Holistic progress monitoring</li>
                    <li>🌐 Community connection tools</li>
                    <li>📱 Mobile-responsive design</li>
                  </ul>
                </div>

                <h3>👕 Hoodie Economics Platform</h3>
                <p>
                  Digital marketplace and tracking system for imagination credits and hoodie 
                  trading. Supports alternative economic models while maintaining transparency 
                  and community trust.
                </p>

                <h3>📱 AIME Connect Mobile App</h3>
                <p>
                  Mobile application for program participants to stay connected, access resources, 
                  share updates, and maintain mentoring relationships. Features offline capability 
                  for areas with limited connectivity.
                </p>

                <h3>🎥 Digital Storytelling Suite</h3>
                <p>
                  Collection of tools for creating, editing, and sharing digital stories. 
                  Includes video editing software, audio recording tools, and story structure 
                  templates that honor Indigenous narrative traditions.
                </p>
                ...
                <ul>
                  <li>Culturally safe discussion spaces</li>
                  <li>Moderated by community leaders</li>
                  <li>Multi-language support</li>
                  <li>Story sharing capabilities</li>
                  <li>Resource exchange features</li>
                </ul>

                <h3>📹 Virtual Meeting Platforms</h3>
                <ul>
                  <li>Circle-based video conferencing</li>
                  <li>Breakout rooms for small group work</li>
                  <li>Screen sharing and collaborative tools</li>
                  <li>Recording capabilities with permissions</li>
                  <li>Accessibility features and closed captioning</li>
                </ul>

                <h3>📲 Messaging and Check-in Systems</h3>
                <ul>
                  <li>Automated reminder and encouragement messages</li>
                  <li>Peer-to-peer communication tools</li>
                  <li>Emergency support contact systems</li>
                  <li>Celebration and recognition features</li>
                  <li>Privacy controls and settings</li>
                </ul>

                <h2>Data and Analytics Tools</h2>

                <h3>📈 Impact Dashboard</h3>
                <p>
                  Real-time visualization of program outcomes, participant progress, and 
                  community impact. Combines quantitative metrics with story highlights 
                  and qualitative insights.
                </p>

                <h3>🔍 Evaluation and Assessment Platform</h3>
                <p>
                  Comprehensive evaluation system that supports multiple data collection 
                  methods including surveys, interviews, story collection, and creative 
                  expression documentation.
                </p>

                <h3>🗺️ Network Mapping Tools</h3>
                <p>
                  Visualization tools for understanding relationship networks, community 
                  connections, and collaboration patterns. Helps identify network 
                  strengthening opportunities.
                </p>

                <h2>Resource Management Systems</h2>

                <h3>📚 Knowledge Repository</h3>
                <ul>
                  <li>Searchable database of resources and tools</li>
                  <li>Cultural protocol documentation</li>
                  <li>Best practice library</li>
                  <li>Template and framework collection</li>
                  <li>Community-contributed content</li>
                </ul>

                <h3>👥 Volunteer and Staff Management</h3>
                <ul>
                  <li>Volunteer recruitment and onboarding</li>
                  <li>Training module delivery and tracking</li>
                  <li>Schedule coordination and communication</li>
                  <li>Performance support and feedback</li>
                  <li>Recognition and appreciation features</li>
                </ul>

                <h2>Cultural and Accessibility Considerations</h2>

                <h3>🌏 Cultural Responsiveness</h3>
                <ul>
                  <li><strong>Language Support:</strong> Multi-language interfaces and content</li>
                  <li><strong>Cultural Imagery:</strong> Appropriate visual representation</li>
                  <li><strong>Protocol Integration:</strong> Built-in cultural protocol reminders</li>
                  <li><strong>Elder Wisdom:</strong> Special recognition for knowledge keepers</li>
                  <li><strong>Ceremony Integration:</strong> Support for traditional practices</li>
                </ul>

                <h3>♿ Accessibility Features</h3>
                <ul>
                  <li><strong>Universal Design:</strong> Accessible to users with disabilities</li>
                  <li><strong>Multiple Formats:</strong> Text, audio, and visual options</li>
                  <li><strong>Mobile Optimization:</strong> Works on all device types</li>
                  <li><strong>Low Bandwidth:</strong> Functions in areas with poor connectivity</li>
                  <li><strong>Digital Literacy:</strong> Intuitive interfaces for all skill levels</li>
                </ul>

                <h2>Implementation and Training</h2>
                <ul>
                  <li><strong>Community Co-design:</strong> Involve users in tool development</li>
                  <li><strong>Gradual Rollout:</strong> Phased implementation with support</li>
                  <li><strong>Digital Literacy Training:</strong> Skill building for effective use</li>
        ...
        default:
          return {
            title: `Tools & Frameworks: ${page}`,
            subtitle: 'Practical resources for transformation',
            content: `
              <div class="prose prose-lg max-w-none">
                <p class="text-gray-600">
                  This section contains specialized tools and frameworks for ${page.replace('-', ' ')}. 
                  Content is being developed to provide comprehensive resources for practical 
                  implementation of Indigenous-informed approaches.
                </p>
              </div>
            `
          }
