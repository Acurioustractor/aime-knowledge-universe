          ...
          <div className="space-y-8">
            <div>
              <Link href="/" className="inline-block mb-6">
                ...
                <div className="text-gray-400 text-sm mt-2">Indigenous custodianship for systems transformation</div>
              </Link>
            ...
            <div className="text-gray-400 text-sm">
              ...
              <p>Twenty years of Indigenous custodianship applied to contemporary challenges</p>
            </div>
          </div>
